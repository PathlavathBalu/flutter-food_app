        ...
        child: ScaleTransition(
          ...
          child: Container(
              ...
              child: Column(
                children: <Widget>[
                   Padding(
                     padding: const EdgeInsets.only(top: 10.0, left: 0.0, right: 220.0),
                     child: Image.asset(
                   ...
                   Padding(
                     padding: const EdgeInsets.only(top: 10.0, left: 0.0, right: 60.0),
                     child: Text(
                        "+916300754683",
                ...
                Navigator.of(context).push(new MaterialPageRoute(
                  builder: (BuildContext context) => new FreechargeProceed(),
                ));
              },
                        ),
                      ),
